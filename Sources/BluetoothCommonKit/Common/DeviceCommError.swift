...
extension DeviceCommError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .procedureRejected(let reason):
            return LocalizedString("The procedure was rejected by the device (reason: \(reason)).", comment: "Error description when a procedure is rejected by the device")
        case .procedureTimeout:
