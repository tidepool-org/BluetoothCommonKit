...
//        }
//        
//        // proof to roche that endianness matters
...
//        let securityManager = SecurityManager(securePersistentPumpAuthentication: { self.mockKeychainManager })
...
//        let sharedKeyDataClient = securityManager.sharedKeyData
//        
...
//        securityManager.generateKeyPair()
//        securityManager.generateSharedSecret(serverPublicKeyData: serverPublicKeyData)
//        let sharedKeyData = securityManager.sharedKeyData!
//        
//        // set the OOB number
...
//        let securityManager = SecurityManager(securePersistentPumpAuthentication: { self.mockKeychainManager }, sharedKeyData: keyData)
...
//        
//        let securityManager = SecurityManager(sharedKeyData: Data(), sequenceNumber: sequenceNumber)
//        securityManager.configuration.serverIVFixedField = ivFixedField
//        securityManager.configuration.clientIVFixedField = ivFixedField
//        
...
//        let ivFixedField: Data = Data(UInt32(12345678))
//        let resourceHandle: ResourceHandle = 1234
//        let securityManager = SecurityManager(securePersistentPumpAuthentication: { self.mockKeychainManager }, sharedKeyData: largeKey)
//        securityManager.configuration.macSize = macSize
//        securityManager.configuration.nonceSizeOctetsVariable = nonceSizeOctetsVariable
//        securityManager.configuration.serverIVFixedField = ivFixedField
//        securityManager.configuration.clientIVFixedField = ivFixedField
...
//        let securityConfigurationID: UInt16 = 2
//        let securityManager = SecurityManager(sharedKeyData: tooShortKeyData)
//        securityManager.configuration.macSize = macSize
//        securityManager.configuration.nonceSizeOctetsVariable = nonceSizeOctetsVariable
//        securityManager.configuration.serverIVFixedField = ivFixedField
//        securityManager.configuration.clientIVFixedField = ivFixedField
...
//    var tidepoolSecurity: TidepoolSecurity? { nil }
//    
